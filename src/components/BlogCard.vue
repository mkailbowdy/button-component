...
<template>
  <article>
    <div class="featuredImage">
      <img src="../assets/spacejoy.jpg" alt="living room with furniture" />
    </div>
    <div class="article">
      <div class="badge">
        <BadgeComponent status="success">Interior</BadgeComponent>
      </div>
      <div class="content">
      ...
      <div class="cta">
        <ButtonComponent hierarchy="tertiary" size="large" icon-right>
          Read more
          <template #icon-right>
