...
<main>
  <section>
    ...
    <form action="https://www.greatfrontend.com/api/projects/challenges/auth/sign-in" method="POST">
      ...
      <InputComponent required type="password" id="password" label="Password" name="password" class="border border-gray-300" :eyeIcon="true"/>
